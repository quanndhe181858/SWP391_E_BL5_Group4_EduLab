    ...
    <body class="bg-gray-100 min-h-screen">
        ...
        <div class="max-w-5xl mx-auto px-6 py-10">
            ...
            <c:if test="${not empty error}">
                <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-800 rounded-lg shadow-sm">❌ ${error}</div>
            </c:if>

            <c:if test="${not empty success}">
                <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 text-green-800 rounded-lg shadow-sm">✅ ${success}</div>
            </c:if>
