...
<html>
    ...
    <head>
        ...
        <title>Quiz Answer Management - EduLab</title>
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-8">
                <div
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Quiz Answer Management</h1>
                        <p class="text-lg text-gray-600 mt-1">Create, edit, and manage quiz answers
                        </p>
                    </div>
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <aside class="w-full lg:w-1/4">
                        <div class="bg-white p-6 rounded-lg shadow-sm sticky top-4">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        type="text" placeholder="Search answers..." id="search"
                                        name="search"
                            ...
                            <div class="mb-6">
                                <label for="quizId"
                                       class="block text-sm font-semibold text-gray-700 mb-2">Quiz</label>
                                <select id="quizId" name="quizId"
                                    ...
                                    <option value="<%= quiz.getId() %>"
                                            <%=String.valueOf(quiz.getId()).equals(selectedQuizId)
                                                                    ? "selected" : "" %>>
                                        Quiz #<%= quiz.getId() %>: <%= quiz.getQuestion()
                            ...
                            <div class="mb-6">
                                <label for="isTrue"
                                       class="block text-sm font-semibold text-gray-700 mb-2">Answer
                                    Type</label>
                            ...
                            <div class="p-6 border-b border-gray-200">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                    <div class="bg-blue-50 p-4 rounded-lg">
                                        <p class="text-sm text-blue-600 font-semibold">Total Answers
                                        </p>
                                        <p class="text-2xl font-bold text-gray-900 mt-1">
                                            ${totalAnswers != null ? totalAnswers : 0}</p>
                                    </div>
                                    <div class="bg-green-50 p-4 rounded-lg">
                                        <p class="text-sm text-green-600 font-semibold">Correct
                                            Answers</p>
                                        <p class="text-2xl font-bold text-gray-900 mt-1">
                                    ...
                                    <div class="bg-red-50 p-4 rounded-lg">
                                        <p class="text-sm text-red-600 font-semibold">Incorrect
                                            Answers</p>
                                        <p class="text-2xl font-bold text-gray-900 mt-1">
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="text-sm text-gray-600">Showing ${startItem != null
                                                                                   ...
                                                                                   ${totalAnswers != null ? totalAnswers : 0} answers</p>
                                        </div>
                                            ...
                                            <select name="sortBy"
                                                ...
                                                <option value="updated_desc"
                                                        ${param.sortBy=='updated_desc' || param.sortBy==null
                                                          ? 'selected' : '' }>Recently Updated</option>
                                    ...
                                    <div class="space-y-4">
                                                        ...
                                                        <div class="flex-grow">
                                                            <div
                                                                ...
                                                                <span class="px-2 py-1 text-xs font-semibold <%= 
                                                                    ...
                                                                    <%= answer.isIs_true() ? "Correct" : "Incorrect" %>
                                                                </span>
                                                                <span class="px-2 py-1 text-xs font-semibold <%= answer.isIs_true() ? "text-green-600 bg-green-100" : "text-red-600 bg-red-100" %> rounded">
                                                                    <%= answer.isIs_true() ? "Correct" : "Incorrect" %>
                                                                </span>
                                        ...
                                        <div class="text-center py-12">
                                            ...
                                            <h3
                                                ...
                                                No answers found</h3>
                                            <p class="mt-1 text-sm text-gray-500">Get
                                                started by creating a new quiz answer.</p>
                                            <div class="mt-6">
                                                <button type="button"
            ...
            <div id="addModal"
                ...
                <div
                    ...
                    <div class="flex items-center justify-between p-6 border-b border-gray-200">
                        <h2 class="text-2xl font-bold text-gray-900">Add New Answer</h2>
                    ...
                    <form action="${pageContext.request.contextPath}/instructor/quiz-answers"
                        ...
                        <div class="p-6 space-y-6">
                            <div>
                                <label for="addQuizId"
                                       class="block text-sm font-semibold text-gray-700 mb-2">Quiz
                            ...
                            <div>
                                ...
                                <textarea id="addContent" name="content" required rows="4"
                                          ...
                                          placeholder="Enter the answer content..."></textarea>
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="addIsTrue"
                                           class="block text-sm font-semibold text-gray-700 mb-2">Is
                                        Correct Answer? <span
                                ...
                                <div>
                                    ...
                                    <input type="text" id="addType" name="type"
                                           ...
                                           placeholder="e.g., text, image, etc.">
                                </div>
                            </div>
                        </div>
            ...
            <div id="editModal"
                ...
                <div
                    class="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                    <div class="flex items-center justify-between p-6 border-b border-gray-200">
                        <h2 class="text-2xl font-bold text-gray-900">Edit Answer</h2>
            ...
            <div id="deleteModal"
                ...
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-md">
                    <div class="flex items-center justify-between p-6 border-b border-gray-200">
                        <h2 class="text-xl font-bold text-gray-900">Delete Answer</h2>
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 text-center mb-2">Are you
                            sure you want to delete this answer?</h3>
                        <p class="text-sm text-gray-500 text-center mb-4">This action cannot be
                            undone.</p>
                        <div class="bg-gray-50 rounded-lg p-4 mb-4">
                            <p class="text-sm text-gray-700 font-medium">Answer:</p>
            ...
            <!-- Script for modal click-outside -->
            <script>
