                ...
                <body class="bg-gray-50">
                    ...
                    <div class="container mx-auto px-4 py-8">
                        <div class="mb-8">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                <div>
                                    ...
                                    <p class="text-lg text-gray-600 mt-1">Tạo câu hỏi trắc nghiệm mới cùng với các câu
                                        trả lời</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col lg:flex-row gap-6">
                            ...
                            <main class="w-full">
                                <!-- Quiz Create Form -->
                                <form id="createQuizForm" action="${pageContext.request.contextPath}/instructor/quizzes"
                                    ...
                                    <div class="bg-white rounded-lg shadow-sm mb-6">
                                        <div class="p-6 border-b border-gray-200">
                                            ...
                                            <p class="text-sm text-gray-600 mt-1">Điền thông tin bên dưới để tạo câu hỏi
                                                của bạn</p>
                                        </div>
                                        ...
                                        <div class="p-6">
                                            <div class="mb-6">
                                                ...
                                                <p class="mt-2 text-xs text-gray-500">Nhập đầy đủ nội dung câu hỏi. Hãy
                                                    rõ ràng và cụ thể.</p>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    ...
                                                    <select id="type" name="type" required
                                                        ...
                                                        <option value="Multiple Choice" ${type=='Multiple Choice'
                                                            ? 'selected' : '' }>Multiple Choice</option>
                                                        <option value="Single Choice" ${type=='Single Choice'
                                    ...
                                    <div class="bg-white rounded-lg shadow-sm mb-6">
                                        <div class="p-6 border-b border-gray-200 flex justify-between items-center">
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600 mt-1">Thêm các lựa chọn câu trả lời (tối
                                                    thiểu 2)</p>
                                            </div>
                                        ...
                                        <div class="p-6">
                                            <div id="answersContainer" class="space-y-4">
                                                ...
                                                <c:choose>
                                                    <c:when test="${not empty answerContents}">
                                                        ...
                                                        <c:forEach var="content" items="${answerContents}"
                                                            varStatus="status">
                                                            <div class="flex items-start gap-4 p-4 border border-gray-200 rounded-lg bg-gray-50 answer-row"
                                                                id="answer-row-${status.index}">
                                                                <div class="pt-3">
                                                                    <input type="checkbox" name="answerIsCorrect"
                                                                        value="${status.index}"
                                                                ...
                                                                <div class="pt-1">
                                                                    <button type="button"
                                                                        onclick="removeAnswerField(${status.index})"
                                            ...
                                            <p class="mt-4 text-sm text-gray-500 italic">
                                                * Lưu ý: Tích vào ô vuông bên trái câu trả lời để đánh dấu là câu trả
                                                lời ĐÚNG. Phải có ít nhất 1 câu đúng.
                                            </p>
                                        </div>
                                    </div>
