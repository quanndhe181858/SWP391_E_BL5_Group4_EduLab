                        ...
                        <div class="space-y-4">
                            <c:forEach items="${recentActivities}" var="activity">
                                <div class="flex gap-4 items-start">
                                    <div class="w-10 h-10 rounded-full ${activity.type == 'completed_section' ? 'bg-green-100' : activity.type == 'started_course' ? 'bg-blue-100' : activity.type == 'passed_test' ? 'bg-purple-100' : 'bg-orange-100'} flex items-center justify-center flex-shrink-0">
                                        <c:choose>
