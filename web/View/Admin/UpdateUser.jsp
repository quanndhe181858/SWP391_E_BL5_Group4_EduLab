<%-- 
    Document   : UpdateUser
    Created on : Dec 12, 2025, 1:45:00 PM
    Author     : Le Minh Duc
--%>
    ...
    <body class="bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="ml-64 pt-6 px-6 pb-8">
                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="${pageContext.request.contextPath}/admin/users?page=users" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Cập nhật thông tin</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="bg-white rounded-xl shadow-md p-8">
                <form method="POST" action="${pageContext.request.contextPath}/admin/users" id="updateUserForm">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Date of Birth -->
                            <div>
                                <label for="bod" class="block text-sm font-medium text-gray-700 mb-2">
                                    Ngày sinh
                                </label>
                                <input type="date" 
                                       id="bod" 
                    ...
                    <div class="mb-8 pb-8 border-b border-gray-200">
                        ...
                        <div class="space-y-4">
                            ...
                            <c:forEach var="role" items="${roles}">
                                <div class="flex items-start p-4 border-2 rounded-lg cursor-pointer transition-all ${user.role_id == role.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'}">
                                    <input type="radio" 
                                           id="role${role.id}" 
                                           name="roleId" 
                                           value="${role.id}"
                                    ...
                                    <label for="role${role.id}" class="ml-3 flex-1 cursor-pointer">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <span class="block text-sm font-semibold text-gray-900">${role.name}</span>
                                                <c:if test="${not empty role.description}">
                                                    <span class="block text-sm text-gray-600 mt-1">${role.description}</span>
                                                </c:if>
                                            </div>
                                            <c:choose>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-4 rounded-lg">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-mono font-medium text-gray-900 break-all">${user.uuid}</p>
                            </div>
                            <div>
