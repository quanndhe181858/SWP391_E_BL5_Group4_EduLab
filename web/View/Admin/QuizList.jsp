...
<html>
    ...
    <head>
        ...
        <title>Quản lí câu hỏi - Quản trị viên</title>
    ...
    <body class="bg-gray-50">
        ...
        <div class="ml-64 pt-6 px-6 pb-8">
            <div class="mb-8 flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Quản lí câu hỏi</h1>
                    <p class="text-gray-600 mt-1">Quản lí hệ thống câu hỏi, hiển thị của câu hỏi</p>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <span
                                            ...
                                            ${quiz.type == 'Multiple Choice' ? 'Nhiều lựa chọn' : 'Một lựa chọn'}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        <c:choose>
                                            <c:when test="${quiz.status == 'Hidden'}">
                                                <a href="${pageContext.request.contextPath}/admin/quizzes?action=show&id=${quiz.id}"
                                                   class="text-green-600 hover:text-green-900">Hiển thị</a>
                                            </c:when>
                                            <c:otherwise>
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    Trang <span class="font-medium">${currentPage}</span> của <span
